...
<body background="../../static/img/readerRepasswd.jpg" style=" background-repeat:no-repeat ;
...
<div class="col-xs-6 col-md-offset-3" style="position: relative;">
    <div class="panel panel-primary ">
        ...
        <div class="panel-body">
            <form method="post" action="readerRepasswdDo?readerId=${sessionScope.readerCard.readerId}" class="form-inline" id="repasswd">
